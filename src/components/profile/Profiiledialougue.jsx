...
function Profiledialouge() {
  let[user,setUser] = useState({name:"Rahul Sharma",email:"rahul@gmail.com"});
  return (
    <div className="profile-container">
      ...
      <div className="profile-picture">
        <img className="pen-icon" src={require('../../asset/images/pen.png')}></img>
        <img className="circle-icon" src={require("../../asset/images/circle.png")}></img>
        <img
      ...
      <div className="profile-details">
        ...
        <div class="form-group">
          <label className="label" for="user1">User Name</label>
          <input
            type="text"
             value={user.name}
            id="user1"
